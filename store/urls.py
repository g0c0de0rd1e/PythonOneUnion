...
from .views import item_details, store, tag_details, tag_list, create_order
...
urlpatterns = [
    ...
    path('<slug:item_slug>/buy/', create_order, name='store_buy'),
    path('create-order/', create_order, name='store_buy'),
